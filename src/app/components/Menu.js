...
export function Menu() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-gray-900 py-10 text-gray-200">
      <h1 className="text-3xl font-mono text-center mb-6 text-green-500">
        Our Featured Menu
      </h1>
      <section>
        <Carousel
        ...
        >
          <CarouselContent className="flex justify-center items-center">
            {images.map((image, index) => (
              ...
              >
                <Card className="relative group transition-all duration-300 bg-gray-800 hover:shadow-lg hover:shadow-green-600 rounded-lg">
                  <CardContent className="relative flex flex-col items-center p-4">
                    ...
                    <h3 className="text-lg font-bold text-center mb-1 text-green-400">
                      {head[index]}
                    </h3>
